    ...
    <>
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card title="Model Configuration | 模型配置">
            <SelectInput
          ...
          <Card title="Target Configuration | 目标配置">
            <SelectInput
          ...
          <Card title="Save Configuration | 保存配置">
            <SelectInput
        ...
        <div>
          <Card title="Training Configuration | 训练配置">
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
              ...
              <div>
                ...
                <NumberInput
                  ...
                  min={0}
                />
                <FormGroup label="Unload Text Encoder | 卸载文本编码器" className="pt-2">
                  <div className="grid grid-cols-2 gap-2">
                    <Checkbox
              ...
              <div>
                <FormGroup label="Regularization | 正则化">
                  <Checkbox
                    label="Differential Output Preservation | 差分输出保持"
                    className="pt-1"
        ...
        <div>
          <Card title="Sample Configuration | 采样配置">
            <div
              className={
                isVideoModel
